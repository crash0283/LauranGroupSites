...
<head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous">    <link href="https://fonts.googleapis.com/css?family=Scope+One|IM+Fell+DW+Pica" rel="stylesheet">
...
<body>
    ...
    <div class="container-fluid">
        <section class="title-row">
            <div class="fill-screen" style="background-image: url('images/seagate/Balcony_FIXED.jpg');">
        ...
        <section class="row text-banner">
            <div id="descript"> <img id="beachIcon" src="images/seagate/beach.png" alt="" />
            ...
            <ul class="accomodations list-unstyled aList"> <i class="fa fa-bed fa-5x" aria-hidden="true"></i>
                <li>3 Bedroom (1 King Bed, 3 Queen Beds)</li>
                <li>2 Full Baths</li>
                <li>Sleeper Sofa (Family Room)</li>
                <li>Fully Equipped Kitchen - Stove, Dishwasher, Cooking Utensils, Dishes, Microwave, Toaster, and Coffeemaker</li>
                <li>Washer/Dryer - Linens and Towels Provided</li>
                <li>Air Conditioning</li>
                <li>(4)-Flat Panel Smart HDTV's, Cable, Internet Access, DVD Player</li>
        ...
        <section id="activities" class="row activity-section">
            ...
            <div class="activity-element col-md-4"> <img src="images/seagate/Starfish.png" />
                <h2>The Beach</h2>
                <p>The beach is located right off the condo and has some of the best sand along the Gulf Coast. Its sugary white texture is perfect for building sand castles with the kids or digging your feet in for some relaxation time. If you already had plenty of sun, our balcony offers a perfect view of the beach. So, if you have children, you'll be able to watch them from above. Also, if you are lucky, you might be able to spot some dolphins making their way up the coast! The beaches are raked almost every morning, so get there before hand if you want to collect some shells or find some buried treasure! Fishing off the beach is allowed, as well, so head over to the nearest bait shop for the latest fishing report. Adjacent to the beach is where you'll find the condo shower for washing off before heading in. Don't forget about the BEAUTIFUL sunsets. Watch them from the beach or the balcony! If you want to venture out a bit, <a href="http://www.clearwaterbeach.com" target="_blank">Clearwater Beach</a> is located just 20 min north of Sea Gate and has been voted #1 Best Beach in the USA!</p>
            </div>
            <div class="activity-element col-md-4"> <img src="images/seagate/Shop.png" />
                <h2>Shopping</h2>
                <p>If shopping is on your list of things to do when visiting us, you won't be disappointed. <a href="http://www.johnspass.com/" target="_blank">John's Pass</a> is located just 7 miles south of Sea Gate on Gulf Blvd. It features a waterfront tourist area with TONS of souvenir shops, watercraft and boat rentals, restaurants, and more! Johns Pass is a wonderful place to go with the family for the day. If you like Flea Markets, <a href="http://thewagonwheelfleamarket.com/" target="_blank">The Mustang Flea Market</a> is the area's largest open-air flea market and only minutes away by car. Looking for boat rentals? <a href="https://islandmarinerentals.com" target="_blank">Island Marine Rentals</a> has been voted #1 Best Boat Rentals 5 Years in a row and its located just 3 minutes north off Gulf Blvd! Other shopping experiences include <a href="http://www.shopinternationalplaza.com/" target="_blank">Tampa's International Plaza</a> located in Tampa and <a href="http://www.simon.com/mall/tyrone-square/about" target="_blank">Tyrone Square Mall</a> which is only about 10 miles away from Sea Gate!</p>
            </div>
            <div class="activity-element col-md-4"> <img src="images/seagate/Golf_Activity.png" />
                <h2>Golf</h2>
                <p>Ready to hit the links? Experience some of the great golf courses that the surrounding areas of Sea Gate has to offer! <a href="http://baypointegolf.net/" target="_blank">Baypointe Golf Club</a> is a great little golf facility that lies just a few miles east of the inter coastal and the Gulf of Mexico. Its an 18 hole course that's only 5 minutes from Indian Rocks Beach. <a href="http://www.tidesgc.com/" target="_blank">The Tides Golf Club</a> is a beautiful 18 hole golf club located in Seminole, FL. Although not a long course, The Tides will challenge players of all levels with their tree-lined fairways and elevated greens. Designed by world famous golf architect Donald Ross, <a href="https://www.belleviewbiltmoregolf.com/" target="_blank">Belleview Biltmore Golf Club</a> is a challenging 18 hole course that's located in Belleair, FL, which is minutes away from Sea Gate. <a href="http://www.golfstpete.com/mangrove_bay.html#ad-image-0" target="_blank">Mangrove Bay</a> is another beautiful course located in St. Petersburg,FL. It features an 18 hole championship golf course, as well as a driving range and fully stocked pro shop. Some other great courses to check out are: <a href="http://www.clearwatercountryclub.com/" target="_blank">Clearwater Country Club</a>, <a href="http://www.chichi.org/golf-course/" target="_blank">Chi Chi Rodriguez Golf Club</a>, and <a href="http://tarponwoodsgc.com/#" target="_blank">Tarpon Wood Golf Club</a>.</p>
            </div>
            <div class="clearfix"></div>
            <div class="activity-element col-md-4"> <img src="images/seagate/Lion.png" />
                <h2>On Land</h2>
                ...
                <p><a href="http://www.smugglersgolf.com/" target="_blank">Smuggler's Cove Adventure Mini Golf</a> is located just across the street from Sea Gate and features an 18 hole miniature golf course perfect for the entire family!</p>
            ...
            <div class="activity-element col-md-4"> <img src="images/seagate/Eat_01.png" />
                <h2>Eating</h2>
                <p>Where to Eat? Finding a great place to eat near Seagate is REALLY simple!</p>
                <p><a href="http://www.saltrockgrill.com/" target="_blank">Salt Rock Grill</a>, one of the best restaurants in the Tampa/St.Petersburg area, is located adjacent to Sea Gate. This is a fine dining establishment with excellent food and drinks, as well as their very own wine cellar with many fine choices! They offer both indoor and outdoor waterfront dining along the InterCoastal Waterway.</p>
                <p><a href="http://www.johnspass.com/" target="_blank">Johns Pass Village & Boardwalk</a> offers many different dining experiences that are close by. Some of these include: <a href="http://www.gofriendlyfisherman.com/" target="_blank">Friendly Fisherman</a>, <a href="http://sculleysrestaurant.com/" target="_blank">Sculley's</a>, <a href="http://thehutbarandgrill.com/" target="_blank">The Hut Tiki Bar and Grille</a>, <a href="http://www.waltzfishshak.com/" target="_blank">Waltz Fish Shak</a>, <a href="http://www.bubbagump.com/" target="_blank">Bubba Gump Shrimp Company</a>, <a href="http://www.delosaspizza.com/" target="_blank">DeLosa's Pizzeria and Resturant</a>, and Pirates Pub and Grub.
                    </p>
            ...
            <div class="activity-element col-md-4"> <img src="images/seagate/Wheel.png" />
                <h2>On Water</h2>
            ...
            <div class="col-md-4 col-md-offset-4 form">
                ...
                <form id="contactForm" action="php/mailer.php" class="form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="Email Address" name="email" required> </div>
                    <div class="form-group">
                        <label for="phone">Phone</label>
                        <input type="text" class="form-control" id="phone" placeholder="Phone" name="phone"> </div>
                    <div class="form-group">
